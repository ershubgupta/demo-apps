...
/** Supported tabs on the catalog store detail page. */
...
const TAB_META: Record<DetailTab, { labelKey: string; panelId: string }> = {
  items: {
    ...
    panelId: "catalog-store-tab-panel-items",
  },
  customers: {
    labelKey: "details.tabs.catalogCustomer",
    panelId: "catalog-store-tab-panel-customers",
  },
};

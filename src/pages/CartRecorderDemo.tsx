      ...
      <header className="legacy-cart-header">
        <div className="legacy-cart-header-inner">
          <div className="legacy-cart-brand-group">
            <a className="legacy-icon-button" href="/" aria-label="Back to demos">
              &lt;
            </a>
          ...
          <div className="legacy-cart-actions">
            ...
            <button type="button" className="legacy-button legacy-button-outline" data-testid="start-over-button" onClick={resetDemo}>
              Start over
            </button>
          </div>
        </div>
...
function ProductDetailView({ product, onAddToCart, onBack }: { product: DemoProduct; onAddToCart: () => void; onBack: () => void }) {
  return (
